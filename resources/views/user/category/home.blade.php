              ...
              <div class="row">
                  ...
                  <ul class="list-group col-md-12">
                    @foreach($categories as $category)
                        ...
                        {{ $category->name }}
                        <span class="badge badge-success badge-pill pull-right">{{count($category->posts)}}</span>
                      </li>
                      </a>
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                   ...
                   <a href="{{ route('user.readpost',$newpost->id) }}"> <li class="list-group-item text-success">{{ $newpost->title }}</li></a>
                    @endforeach
                </ul>
